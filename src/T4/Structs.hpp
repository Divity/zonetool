...
namespace ZoneTool
{
	namespace T4
	{
        ...
        struct __declspec(align(4)) XQuat
        {
            int16_t value[4];
        };

        struct __declspec(align(4)) XQuat2
        {
            int16_t value[2];
        };
        ...
        typedef __declspec(align(16)) XSurfaceTri XSurfaceTri16;
        ...
        enum ShaderCodeConstants
        {
            ...
            CONST_SRC_CODE_GRASS_FORCE_0 = 0x3F,
            CONST_SRC_CODE_GRASS_FORCE_1 = 0x40,
            CONST_SRC_CODE_GRASS_FORCE_0_EX = 0x41,
            CONST_SRC_CODE_GRASS_FORCE_1_EX = 0x42,
            CONST_SRC_CODE_GRASS_WIND_FORCE_0 = 0x43,
            CONST_SRC_CODE_MOTIONBLUR_DIRECTION_AND_MAGNITUDE = 0x44,
            CONST_SRC_CODE_FLAME_DISTORTION = 0x45,
            CONST_SRC_CODE_BLOOM_SCALE = 0x46,
            CONST_SRC_CODE_OVERLAY_TEXCOORD = 0x47,
        ...
        enum MaterialTextureSource
        {
            ...
            TEXTURE_SRC_CODE_DYNAMIC_SHADOW = 0x12,
        ...
        typedef __declspec(align(16)) cbrush_t cbrush_array_t;
